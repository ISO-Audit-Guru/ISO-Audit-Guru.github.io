Gem::Specification.new do |spec|
  spec.name          = "iso-audit-guru.github.io"
  spec.version       = "0.0"
  spec.authors       = ["Sanjay Seetharaman"]
  spec.email         = ["sanjayms0111@gmail.com"]

  spec.summary       = "iso-audit-guru.github.io Jekyll Theme"
  spec.homepage      = "https://github.com/iso-audit-guru/iso-audit-guru.github.io"
  spec.license       = "MIT"
